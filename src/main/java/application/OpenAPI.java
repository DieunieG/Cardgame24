...
public class OpenAPI {
    ...
    private static final String API_KEY = "AIzaSyA5LU14Ih51r1YQkm9mkKRwAW4uyItHeFs";
    ...
    private static String extractSolution(String jsonResponse) {
        try {
            ...
            if (!json.has("candidates")) {
                return "Error: candidates is not found in response";
            }

            JSONObject candidate = json.getJSONArray("candidates").getJSONObject(0);

            if (!candidate.has("content")) {
                return "Error: content is not found in candidate";
            }

            JSONObject content = candidate.getJSONObject("content");

            if (!content.has("parts")) {
                return "Error:parts is not  found in content";
            }
            ...
            return "Opps extracting solution";
        }
    }
}
